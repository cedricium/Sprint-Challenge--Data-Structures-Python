...
class LinkedListTests(unittest.TestCase):
    ...
    def test_custom_reverse(self):
        self.list.add_to_head(10)
        self.list.add_to_head(9)
        self.list.add_to_head(8)
        self.assertEqual(self.list.head.value, 8)
        self.list.reverse_list(self.list.head, None)
        self.assertEqual(self.list.head.value, 10)
        self.assertEqual(self.list.head.get_next().value, 9)
        self.assertEqual(self.list.head.get_next().get_next().value, 8)
